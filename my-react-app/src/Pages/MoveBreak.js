  ...
  const [showImages, setShowImages] = useState([
    {
      ...
      src: image1,
      name: "plank Jacks",
      instructions: "Start in plank position with your arms extended and hands under your shoulders"+
    ...
    },
    {
      ...
      src: image2,
      name: "Lunges",
      instructions: "1. Stand with your feet hip-width apart, keep your back straight, your shoulders back, and your abs tight."+
...

	{
		...
		instructions: "1. Stand straight with your feet shoulder-width apart."+
...

	  {
		...
		src: image5,
		name: "Bunded Squats",
		instructions: "1. Stand with your feet slightly more than hip-width apart with a loop or mini loop band just above your knees." +
...

	  {
		...
		src: image6,
		name: "High Knees",
		instructions: "1.Stand with your feet hip-width apart. Lift up your left knee to your chest."+
...

	  {
		...
		src: image7,
		name: "Lunge Jumps",
		instructions: "1.Take a large step backward and lower your hips, so that your back knee is just above the floor, and your front thigh is parallel to the floor." +
      ...
      <div className="activities-container">
        ...
        <div className="right-container">
          ...
          {showImages.map((images) => (
            <p onClick={() => handleClick(images)}>{images.name}</p>
          ))}
        </div>
      </div>
      <div>
        ...
        >
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">{currentImage && currentImage.instructions}</div>
